...
final Uri _url1 = Uri.parse('https://webxr.run/Zn16exWgve2ll');
final Uri _url2 = Uri.parse('https://webxr.run/XV8P8eaDAZlNo');
      ...
      home: Scaffold(
        ...
        children: [
          ...
          LessonCard(
            ...
            heading: "Pyramid",
            paragraph: "Learn everything  about Pyramids and its formulas",
            gameButtonImagePath: "assets/gameButton.png",
            onTap: _launchUrl1,
          ),
          LessonCard(
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    Padding(
                      padding:
                          const EdgeInsets.only(top: 27, right: 60, bottom: 5),
                      child: Container(
                        width: 115,
                        height: 25,
                        child: Text(
