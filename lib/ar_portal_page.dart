                            ...
                            child: Padding(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  const SizedBox(
                                      width:
                                          170), // Spacer between the two containers
                                  Container(
                                    width: 50,
                                    height: 50,
                                    decoration: ShapeDecoration(
                                              ...
                                              Row(
                                                children: [
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: Icon(
                                                      Icons
                                                          .local_taxi_outlined, // Replace with the desired icon
                                                      color: Colors
                                                          .black, // Set the desired icon color
                                                      size:
                                                          24, // Set the desired icon size
                                                    ),
                                                  ),
                                                  Padding(
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: Icon(
                                                      Icons
                                                          .timer_outlined, // Replace with the desired icon
                                                      color: Colors
                                                          .black, // Set the desired icon color
                                                      size:
                                                          24, // Set the desired icon size
